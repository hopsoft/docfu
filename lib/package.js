import {closest, dirname, exists, join, read, realpath} from './file-system.js'
...
function findPackageJSON(dir) {
  ...
  if (!exists(dir)) {
    console.warn(theme.warning('✗ NOT FOUND'), theme.tertiary('findPackageJSON'), theme.tertiary(dir))
    return
  }
